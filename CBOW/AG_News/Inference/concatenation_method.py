...
def buildInferenceModel():
    ...
    dense1 = Dense(1024, activation='relu', kernel_initializer='orthogonal', bias_initializer='ones')(input_layer)
    dense2 = Dense(256, activation='relu', kernel_initializer='orthogonal', bias_initializer='ones')(dense1)
    drop1 = Dropout(0.3)(dense2)
    dense3 = Dense(64, activation='relu', kernel_initializer='orthogonal', bias_initializer='ones')(drop1)
    drop2 = Dropout(0.3)(dense3)
    dense4 = Dense(16, activation='relu', kernel_initializer='orthogonal', bias_initializer='ones')(drop2)
    drop3 = Dropout(0.3)(dense4)
    dense5 = Dense(1, name='output', activation='sigmoid')(drop3)

    inferenceModel = Model(inputs=[src_input, down_input], outputs=dense5)
...
def trainingEvaluation(numInferenceSamples):
    ...
    sampleNo = randint(0, numInferenceSamples)
