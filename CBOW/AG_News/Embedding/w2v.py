...
def pretrain(_epochs=100, _vector_size=20, _min_count=3):
    ...
    pretrainedModel = Word2Vec(getSourceData(), vector_size=_vector_size, min_count=_min_count)
...
def fineTune(data, i, _vector_size=20, _min_count=1, _epochs=100):
    ...
    w2vModel = Word2Vec(vector_size=_vector_size, min_count=_min_count, sample=0)
